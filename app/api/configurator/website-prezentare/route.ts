...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    await transporter.sendMail({
      from,
      to,
      subject: `[LEAD NOU] Configurator Website Prezentare - ${data.nume}`,
      html: `
        <div style="font-family:sans-serif;max-width:700px;margin:0 auto">
          <h2 style="color:#2B8FCC;margin-bottom:4px">Lead nou - Configurator Website Prezentare</h2>
          ...
          <table style="border-collapse:collapse;width:100%;margin-bottom:20px">
            ...
            ${row('Numar pagini', data.nrPagini)}
            ${row('Obiectiv principal', data.obiectiv)}
          </table>
    ...
    await transporter.sendMail({
      ...
      html: `
        <div style="font-family:sans-serif;max-width:600px;margin:0 auto">
          ...
          <p>Am primit cererea ta pentru un <strong>website de prezentare</strong> si o vom analiza imediat.</p>
