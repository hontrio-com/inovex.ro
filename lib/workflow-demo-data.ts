...
export const SCENARIOS: Scenario[] = [
  {
    ...
    nodes: [
      ...
      { id: 'n2', type: 'ai', title: 'Analizeaza continut', subtitle: 'GPT-4o, 1-2 secunde', icon: 'Brain' },
      { id: 'n3', type: 'conditie', title: 'Ce tip de email?', icon: 'GitBranch', branches: ['Lead nou', 'Reclamatie', 'Altele'] },
      { id: 'n4a', type: 'actiune', title: 'Adauga lead in CRM', icon: 'UserPlus' },
      { id: 'n4b', type: 'actiune', title: 'Creeaza ticket suport', icon: 'Ticket' },
      { id: 'n5', type: 'ai', title: 'Genereaza raspuns', subtitle: 'Personalizat pe context', icon: 'PenLine' },
      { id: 'n6', type: 'actiune', title: 'Trimite reply automat', icon: 'Send' },
      { id: 'n7', type: 'notificare', title: 'Notifica agentul', subtitle: 'Slack + email intern', icon: 'Bell' },
    ],
    connections: [
      { from: 'n1', to: 'n2' },
      { from: 'n2', to: 'n3' },
  ...
  },
  {
    ...
    nodes: [
      ...
      { id: 'n3', type: 'conditie', title: 'Poate AI rezolva?', icon: 'HelpCircle', branches: ['Da - rezolva auto', 'Nu - escaleaza'] },
